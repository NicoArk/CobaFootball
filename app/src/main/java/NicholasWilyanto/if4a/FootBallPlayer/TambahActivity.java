package NicholasWilyanto.if4a.FootBallPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nama.trim().equals(""))
                {
                    etNama.setError("Your name has to be filled!");
                } else if (nomor.trim().equals("")) {
                    etNomor.setError("Your back number is?");

                }
                else if (klub.trim().equals(""))
                {
                    etKlub.setError("Mickey mouse clubhouse request your club number!");
                }
                else
                {
                   ...
                   {
                       Toast.makeText(TambahActivity.this, "Berhasil menambah your data! :3", Toast.LENGTH_SHORT).show();
                       finish();
                   }
                }
            }
